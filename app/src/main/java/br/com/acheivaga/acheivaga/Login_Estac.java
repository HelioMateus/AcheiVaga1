...
import br.com.acheivaga.acheivaga.R;

public class Login_Estac extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_estac);
        ...
        btnEntra.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((edtEmail.getText().toString().isEmpty()) || (edtSenha.getText().toString().isEmpty())) {
                    Toast.makeText(Login_Estac.this, "Preencha os campos de email e senha", Toast.LENGTH_LONG).show();
        ...
        mAuth.signInWithEmailAndPassword(email, senha).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {//caso email e senha validos chama boas vindas
                    ...
                    Toast.makeText(Login_Estac.this, "seja bem vinfo", Toast.LENGTH_LONG).show();

                } else {
                    Log.i("login", "falha ao fazer login" + task.getException());
                    Toast.makeText(Login_Estac.this, "usario ou senha invalido", Toast.LENGTH_LONG).show();
                }
            }
        });
